...
def process_pdf (pdf_path, fn, pdf_pwd='', *args):
...
### Table of Contents
def _parse_toc (doc):
    """With an open PDFDocument object, get the table of contents (toc)"""
    toc = []
    try:
        ...
        print("{} has no TOC ".format(doc._parser.fp.name))
    return toc

def get_toc (pdf_doc, pdf_pwd=''):
    """Return the table of contents (toc), if any, for this pdf file"""
    return process_pdf(pdf_doc, _parse_toc, pdf_pwd)
